...
var AuthenticationHelper = function () {
  ...
  AuthenticationHelper.prototype.computehkdf = function computehkdf(ikm, salt) {
    ...
    var infoBitsUpdate = _awsSdkReactNative.util.buffer.concat([this.infoBits, new _awsSdkReactNative.util.Buffer(String.fromCharCode(1), 'utf8')]);
  ...
  AuthenticationHelper.prototype.getPasswordAuthenticationKey = function getPasswordAuthenticationKey(username, password, serverBValue, salt) {
    ...
    var hkdf = this.computehkdf(new _awsSdkReactNative.util.Buffer(this.padHex(sValue), 'hex'), new _awsSdkReactNative.util.Buffer(this.padHex(this.UValue.toString(16)), 'hex'));
